...
const STRIP = [
  ...
  { label: "Facebook", href: "https://www.facebook.com/profile.php?id=61575861587304" },
...
const ELSEWHERE = [
  ...
  { label: "Photography", href: "https://bhanumendis.godaddysites.com" },
  { label: "Linktree", href: "https://linktr.ee/bhanu_mendis" },
] as const;
    ...
    <footer aria-label="Site footer">
      <div className="foot-top">
        <div className="foot-brand">
          ...
          {/* role="group": aria-label is ignored (and flagged) on a role-less div. */}
          <div className="socials-row" role="group" aria-label="Social media links">
            {SOCIALS.map((s) => (
              <a
                key={s.label}
                href={s.href}
      ...
      <div className="foot-strip" role="group" aria-label="Social profiles">
        {STRIP.map((s) => (
