...
const ALL_EVENTS: readonly TimelineEvent[] = [
  ...
  {
    year: "2026",
    title: "Maathra 15 · Group IT at Lyceum Global Holdings",
    desc: "Overall coordinated Maathra 15 for a second consecutive year, again as Assistant to Senior Lecturer Mr. Rasika Kothalawala. In July joined Lyceum Global Holdings as an intern in the Group IT sector, on site at Lyceum Campus — working under the Director of Group IT and Digital Transformation on a function spanning 50+ group companies, 5,000+ employees and 100+ systems.",
    tags: ["Event", "Group IT", "Internship"],
    side: "left",
    highlight: true,
  },
  {
    year: "2026 – 29",
    title: "Present · BSc (Hons) Artificial Intelligence",
    desc: "Reading for a BSc (Hons) in Artificial Intelligence and Computing at NSBM Green University, offered by the University of Plymouth, United Kingdom — alongside teaching Pearson Edexcel Science, Mathematics and Computer Science at The Science Brainery, and the Group IT internship at Lyceum Global Holdings.",
    tags: ["Present", "NSBM", "Educator"],
    side: "right",
    active: true,
  },
];
